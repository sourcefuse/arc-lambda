...
import {AuthDbSourceName, Tenant, TenantConfig, TenantConfigRepository} from "@sourceloop/authentication-service";

export class TenantRepository extends DefaultSoftCrudRepository<Tenant,
    typeof Tenant.prototype.id> {
    public readonly tenantConfigs: HasManyRepositoryFactory<TenantConfig,
        typeof Tenant.prototype.id>;
